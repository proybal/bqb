...
SECRET_KEY = '$l=a@tpu2!$q-=js_rp_proakz#0%0mjqokvr)_fxmjwxegtq('
...
# Advanced User Sign Up https://dev.to/coderasha/create-advanced-user-sign-up-view-in-django-step-by-step-k9m
